...
import com.morsun.springbootinit.model.dto.user.UserPasswordUpdateRequest;
import com.morsun.springbootinit.model.dto.user.UserQueryRequest;
import com.morsun.springbootinit.model.dto.user.UserRegisterRequest;
import com.morsun.springbootinit.model.entity.User;
import com.morsun.springbootinit.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * @return
     */
    private String encodePassword(String ps){
        String encrypt = DigestUtils.md5DigestAsHex((SALT + ps).getBytes());
        return encrypt;
    }
    ...
    public long userRegister(UserRegisterRequest userRegisterRequest) {
     ...
     MultipartFile avatarFile = userRegisterRequest.getAvatarFile();
        ...
        synchronized (userAccount.intern()) {
            ...
            // todo ：调用cos上传头像，并返回头像地址保存到user中
    ...
    // 检查密码是否正确
    @Override
    public boolean checkPasswordTF(UserPasswordUpdateRequest userPasswordUpdateRequest, String libPassword){
        String oldPassword = userPasswordUpdateRequest.getOldPassword();
        String encodePassword = encodePassword(oldPassword);
        return  StringUtils.equals(encodePassword,libPassword);
    }

    // 修改密码是否正确
    @Override
    public boolean updatePassword(UserPasswordUpdateRequest userPasswordUpdateRequest, Long id){
        String newPassword = userPasswordUpdateRequest.getNewPassword();
        String encryptNew = encodePassword(newPassword);
